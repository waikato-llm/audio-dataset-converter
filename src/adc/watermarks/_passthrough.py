...
class PassThroughMarker(Watermarker):
    """
...
class PassThroughDetector(WatermarkDetector):
    """
    Dummy, just passes through the data, performs no detection.
    """
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Dummy, just passes through the data, performs no detection."
