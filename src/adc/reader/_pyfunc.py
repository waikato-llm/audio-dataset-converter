...
from adc.api import DATATYPES, data_type_to_class, AudioData, Reader, load_function


class PythonFunctionReader(Reader):
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("-i", "--input", type=str, help="Path to the audio file(s) to read; glob syntax is supported", required=False, nargs="*")
        parser.add_argument("-I", "--input_list", type=str, help="Path to the text file(s) listing the audio files to use", required=False, nargs="*")
