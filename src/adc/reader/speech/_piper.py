...
class PiperSpeechReader(Reader, VariableSupporter):
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("-i", "--input", type=str, help="Path to the metadata CSV file(s) to read; glob syntax is supported; " + variable_list(obj=self), required=False, nargs="*")
