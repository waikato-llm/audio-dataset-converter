...
class TxtAudioClassificationReader(Reader, PlaceholderSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Loads the audio classification from the associated .txt file. Speaker information can be loaded from a companion file by supplying a speaker suffix."
    ...
    def read(self) -> Iterable:
        ...
        result = AudioClassificationData(source=audio, annotation=transcript)
