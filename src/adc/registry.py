...
ENV_ADC_CLASS_LISTERS = "ADC_CLASS_LISTERS"

# environment variable with comma-separated list of class listers to exclude
ENV_ADC_CLASS_LISTERS_EXCL = "ADC_CLASS_LISTERS_EXCL"

# the default class listers to inspect (for development)
# can be overridden with ADC_CLASS_LISTERS environment variable
DEFAULT_ADC_CLASS_LISTERS = [
    "adc.class_lister",
]
...
def available_generators() -> Dict[str, Plugin]:
    ...
    :rtype: dict
    """
    return REGISTRY.plugins("adc.api.Generator", fail_if_empty=False)
