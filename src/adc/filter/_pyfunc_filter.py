...
class PythonFunctionFilter(Filter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "The declared Python function processes audio containers of the specified input type and generates ones of the specified output type. The function must handle a single audio container or an iterable of audio containers and return a single audio container or an iterable of audio containers."
