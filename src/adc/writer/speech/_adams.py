...
from adc.api import SpeechData, SplittableStreamWriter, make_list


class AdamsSpeechWriter(SplittableStreamWriter):

    def __init__(self, output_dir: str = None, transcript_field: str = None,
