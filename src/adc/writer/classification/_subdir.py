...
class SubDirAudioClassificationWriter(SplittableStreamWriter, InputBasedPlaceholderSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Saves audio files to sub-directories, using the classification label for the sub-directory."
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("-o", "--output", type=str, help="The directory to create the sub-directories in according to the classification labels. Any defined splits get added beneath there. " + placeholder_list(obj=self), required=True)
        return parser
