...
class TxtAudioClassificationWriter(SplittableStreamWriter, AnnotationsOnlyWriter, InputBasedVariableSupporter):
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Saves the classification label in a .txt file alongside the audio file. If a speaker suffix is defined, then available speaker information gets stored in an additional companion file."
    ...
    def write_stream(self, data):
        ...
        for item in make_list(data):
            ...
            if item.has_annotation():
                ...
                self.logger().info("Writing classification label to: %s" % path)
