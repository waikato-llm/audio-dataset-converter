...
Saves the speech data in Piper format (https://github.com/rhasspy/piper/blob/master/TRAINING.md#dataset-format). If no speaker key is specified, assumes the data to be single-speaker.

```
usage: to-piper-sp [-h] [-l {DEBUG,INFO,WARNING,ERROR,CRITICAL}]
                   [-N LOGGER_NAME] [--skip]
                   [--split_ratios SPLIT_RATIOS [SPLIT_RATIOS ...]]
                   [--split_names SPLIT_NAMES [SPLIT_NAMES ...]]
                   [--split_group SPLIT_GROUP] -o OUTPUT [--metadata METADATA]
                   [--speaker_key SPEAKER_KEY] [--rel_path REL_PATH]
                   [--annotations_only]

Saves the speech data in Piper format
(https://github.com/rhasspy/piper/blob/master/TRAINING.md#dataset-format). If
no speaker key is specified, assumes the data to be single-speaker.
...
options:
  ...
  -o OUTPUT, --output OUTPUT
                        The directory to store the audio/metadata files in.
                        ...
                        None)
  --metadata METADATA   The name of the meta-data file. (default:
                        metadata.csv)
